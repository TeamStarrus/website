...
module.exports = {
    ...
    let row = new ActionRowBuilder().addComponents(new ButtonBuilder().setStyle(ButtonStyle.Link).setLabel(`Top.gg üzerinden oy ver!`).setURL(`https://top.gg/bot/${client.user.id}/vote`));
