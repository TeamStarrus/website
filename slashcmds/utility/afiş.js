...
module.exports = {
  ...
  .addSubcommand(subcommand => subcommand
    .setName(`üye`)
    .setDescription(`Sizin veya seçtiğiniz üyenin afişini gönderir.`)
    .addUserOption(option => option
      .setName(`üye`)
      .setDescription(`Afişini görmek istediğiniz üyeyi seçin.`)
      .setRequired(false)
    )
  )
  .addSubcommand(subcommand => subcommand
    .setName(`sunucu`)
    .setDescription(`Bulunduğunuz sunucunun afişini gönderir.`)
  ),
