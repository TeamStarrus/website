...
module.exports = {
  ...
  .addSubcommand(subcommand => subcommand
    .setName(`üye`)
    .setDescription(`Sizin veya seçtiğiniz üyenin detaylı bilgisini gönderir.`)
    .addUserOption(option => option
      .setName(`üye`)
      .setDescription(`Detaylı bilgisini görmek istediğiniz üyeyi seçin.`)
      .setRequired(false)
    )
  )
  .addSubcommand(subcommand => subcommand
    .setName(`sunucu`)
    .setDescription(`Bulunduğunuz sunucunun detaylı bilgisini gönderir.`)
  ),
  ...
  if (interaction.options.getSubcommand() == `üye`) {
    ...
    member = interaction.options.getMember(`üye`) || interaction.member;
