...
module.exports = {
  ...
  .addSubcommand(subcommand => subcommand
    .setName(`üye`)
    .setDescription(`Sizin veya seçtiğiniz üyenin profil fotoğrafını gönderir.`)
    .addUserOption(option => option
      .setName(`üye`)
      .setDescription(`Profil fotoğrafını görmek istediğiniz üyeyi seçin.`)
      .setRequired(false)
    )
  )
  .addSubcommand(subcommand => subcommand
    .setName(`sunucu`)
    .setDescription(`Bulunduğunuz sunucunun profil fotoğrafını gönderir.`)
  ),
